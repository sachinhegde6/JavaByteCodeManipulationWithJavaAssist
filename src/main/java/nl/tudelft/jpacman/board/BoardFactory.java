...
public class BoardFactory {
    ...
    public BoardFactory(PacManSprites spriteStore) {
		...
		TemplateClass.instrum(27, "Assign", "BoardFactory.BoardFactory().sprites: ",sprites.toString(), "BoardFactory.BoardFactory().spriteStore: ",spriteStore.toString());
    }
    ...
    private static final class Wall extends Square {
        ...
        Wall(Sprite sprite) {
			...
			TemplateClass.instrum(97, "Assign", "Wall.Wall().background: ",this.background.toString(), "Wall.Wall().sprite: ",sprite.toString());
        }
    ...
    private static final class Ground extends Square {
        ...
        Ground(Sprite sprite) {
            this.background = sprite;
			TemplateClass.instrum(130, "Assign", "Ground.Ground().background: ",this.background.toString(), "Ground.Ground().sprite: ",sprite.toString());
        }
