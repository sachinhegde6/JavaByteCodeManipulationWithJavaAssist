...
public class GameFactory {
    ...
    public GameFactory(PlayerFactory playerFactory) {
		...
		TemplateClass.instrum(25, "Assign", "GameFactory.GameFactory().playerFactory: ",playerFactory.toString(), "GameFactory.GameFactory().playerFactory: ",playerFactory.toString());
    }
