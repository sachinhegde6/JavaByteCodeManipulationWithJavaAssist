...
public class    Clyde extends Ghost {
    ...
    static {
		...
		TemplateClass.instrum(66, "Assign", "Clyde.OPPOSITES: ",OPPOSITES.toString(), "Clyde.NORTH: ",Direction.NORTH.toString(), "Clyde.SOUTH: ",Direction.SOUTH.toString());
        OPPOSITES.put(Direction.SOUTH, Direction.NORTH);
		TemplateClass.instrum(67, "Assign", "Clyde.OPPOSITES: ",OPPOSITES.toString(), "Clyde.SOUTH: ", Direction.SOUTH.toString(), "Clyde.NORTH: ",Direction.NORTH.toString());
        OPPOSITES.put(Direction.WEST, Direction.EAST);
		TemplateClass.instrum(68, "Assign", "Clyde.OPPOSITES: ",OPPOSITES.toString(), "Clyde.WEST: ",Direction.WEST.toString(), "Clyde.EAST: ",Direction.EAST.toString());
        OPPOSITES.put(Direction.EAST, Direction.WEST);
		TemplateClass.instrum(69, "Assign", "Clyde.OPPOSITES: ",OPPOSITES.toString(), "Clyde.EAST: ",Direction.EAST.toString(), "Clyde.WEST: ",Direction.WEST.toString());
    }
